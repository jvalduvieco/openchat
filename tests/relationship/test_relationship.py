...
class TestRelationship(TestCase):
    def test_should_create_a_relationship(self):
        ...
        self.assertEqual('2add0450-dbce-4bea-ae48-051d438f1391', relationship.followee_id.contents)
        self.assertEqual('251c6773-18fb-4e83-b19d-5fe9e14aede8', relationship.follower_id.contents)
