...
from tests.fixtures.users import maria, bob_follows_maria, inexistent_user_id, bob
...
class TestCreatePost(TestCase):
    def test_should_get_a_list_of_posts_by_user_id(self):
        ...
        posts_by_user_id = QueryWallByUserID(
            ...
            QueryRelationshipsByFollowerID(InMemoryRelationshipRepository([bob_follows_maria()]))
        )
